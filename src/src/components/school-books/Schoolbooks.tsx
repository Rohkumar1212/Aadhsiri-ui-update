      ...
      <section className="bg-white py-10 px-4 md:px-8">
        ...
        <div className="max-w-7xl mx-auto mb-8 text-left">
          ...
          <p className="text-gray-700 mt-2 text-sm md:text-base">
            Explore our wide range of curriculum-aligned books crafted to meet
            the evolving
            <br /> needs of today’s classrooms.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6">
          ...
          <aside className="w-full md:w-1/4 bg-gray-100 p-4 rounded-lg shadow-sm text-sm">
            {/* Classes */}
            <h3 className="font-bold text-[#C2185B] mb-2">Class Level</h3>
            ...
            {/* Subjects */}
            <h3 className="font-bold text-[#C2185B] mt-4 mb-2">Subjects</h3>
            <ul className="space-y-1">
              {[
                "English",
                "English Grammar",
            ...
            {/* Series */}
            <h3 className="font-bold text-[#C2185B] mt-4 mb-2">Book Series</h3>
            <ul className="space-y-1">
            ...
            {/* Price */}
            <h3 className="font-bold text-[#C2185B] mt-4 mb-2">Price Range</h3>
            <ul className="space-y-1">
              {[
                "100-150",
                "150-200",
            ...
            <ul className="space-y-1">
              {["English", "Hindi", "French", "Urdu", "Sanskrit"].map(
                (item, i) => (
                  <li key={i}>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" className="accent-[#C2185B]" />{" "}
